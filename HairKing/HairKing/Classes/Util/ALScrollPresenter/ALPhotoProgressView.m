...
#define kALDegreeToRadian(x) (M_PI/180.0 * (x))

@implementation ALPhotoProgressView
...
- (void)drawRect:(CGRect)rect
{
    ...
    CGFloat radians = kALDegreeToRadian((_progress*359.9)-90);
    ...
    CGPathAddArc(trackPath, NULL, centerPoint.x, centerPoint.y, radius, kALDegreeToRadian(270), kALDegreeToRadian(-90), NO);
    ...
    CGPathAddArc(progressPath, NULL, centerPoint.x, centerPoint.y, radius, kALDegreeToRadian(270), radians, NO);
